...
class DealerTest {
	...
	void detailTest4() {
		// checks for three of a kind
		ArrayList<Card> three = new ArrayList<Card>();
    	three.add(new Card('C', 12));
    	three.add(new Card('C', 13));
    	three.add(new Card('C', 14));
    	dealer.setDealersHand(three);
    	assertEquals("STRAIGHT FLUSH", dealer.handToString());
	}
	...
	void detailTest5() {
		// checks for three of a kind
		ArrayList<Card> three = new ArrayList<Card>();
    	three.add(new Card('S', 2));
    	three.add(new Card('D', 4));
    	three.add(new Card('C', 5));
    	dealer.setDealersHand(three);
    	assertEquals("HIGH CARD", dealer.handToString());
	}
}